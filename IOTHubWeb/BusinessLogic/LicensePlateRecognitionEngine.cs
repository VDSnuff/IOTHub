...
{
    public class LicensePlateRecognitionEngine : DisposableObject
    {
        ...
        /// </param>
        public LicensePlateRecognitionEngine(String dataPath)
        {
            //create OCR engine
        ...
        private static void TesseractDownloadLangFile(String folder, String lang)
        {
            ...
            String dest = System.IO.Path.Combine("~/App_Data/", String.Format("{0}.traineddata", lang));
            if (!System.IO.File.Exists(dest))
                using (System.Net.WebClient webclient = new System.Net.WebClient())
                {
                    String source =
        ...
        public List<String> DetectLicensePlate(IInputArray img, List<IInputOutputArray> licensePlateImagesList, List<IInputOutputArray> filteredLicensePlateImagesList, List<RotatedRect> detectedLicensePlateRegionList)
        {
